...
namespace Stateless
{
    public partial class StateMachine<TState, TTrigger>
    {
        ...
        public class StateConfiguration
        {
            ...
            {
                EnforceNotIdentityTransition(destinationState);
                string methodInfo = (guard == null) ? null : guard.TryGetMethodInfo().Name;
                return InternalPermitIf(
                    trigger,
                    destinationState,
                    guard,
                    guardDescription ?? methodInfo);
            }
            ...
            {
                MethodInfo methodInfo = (guard == null) ? null : guard.TryGetMethodInfo();
                return InternalPermitIf(
                    trigger,
                    _representation.UnderlyingState,
                    guard,
                    guardDescription ?? methodInfo.Name
                    );
            }
            /// <summary>
            ...
            void EnforceNotIdentityTransition(TState destination)
            {
                ...
                {
                    throw new ArgumentException("Self Transitions Either Ignored Or Reentrant");
                }
            }
